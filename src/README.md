poet_reduced.py file is meant to work with MuonAnalyzer.cc whereas poet_realdata.py works with MuonAnalyzer_realdata.cc. poet_reduced.py and MuonAnalyzer.cc
